export const quotes = [
  ...
  "You cant trust without risk but neither can you live in a cocoon.",
  ...
  "It cant be spring if your heart is filled with past failures.",
  "I may not know everything, but everything is not known yet anyway.",
  "Complaining doesnt change a thing only taking action does.",
  ...
  "A man who doesnt trust himself can never really trust anyone else.",
  ...
  "Sleep is the real beauty secret, but I dont get enough of that.",
  ...
  "Think of tomorrow, the past cant be mended.",
  ...
  "I want you to be everything thats you, deep at the center of your being.",
  ...
  "Genuine sincerity opens peoples hearts, while manipulation causes them to close.",
  ...
  "It isnt where you come from, its where youre going that counts.",
  "The truest greatness lies in being kind, the truest wisdom in a happy mind.",
  "Bite off more than you can chew, then chew it.",
  "Dont ruin the present with the ruined past.",
  ...
  "Progress always involves risks. You cant steal second base and keep your foot on first.",
  ...
  "Dont smother each other. No one can grow in the shade.",
  ...
  "I cant believe that God put us on this earth to be ordinary.",
  ...
  "Always tell the truth. That way, you dont have to remember what you said.",
  ...
  "I dont believe in failure. It is not failure if you enjoyed the process.",
  ...
  "Thats the thing about counter intuitive ideas, they contradict your intuitions. So, they seem wrong.",
  ...
  "You dont play for revenge. You play for respect and pride",
  ...
  "Dont think of it as failure. Think of it as time released success.",
