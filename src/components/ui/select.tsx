...
function SelectTrigger({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Trigger>) {
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex h-8 w-full items-center justify-between gap-2 rounded-md border border-transparent bg-background px-2 text-foreground text-xs shadow-sm transition-colors duration-100 focus:outline-none focus:ring-2 focus:ring-ring",
        className,
      )}
      {...props}
    >
